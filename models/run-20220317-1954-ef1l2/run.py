...
parser.add_str('--weights',           default='noisy_student', help='Name of pretrained weights. E.g.: imagenet, noisy-student, imagenet21k+imagenet2012, imagenet21k, or None')
...
def init_model(print_summary=True):
    model = tf.keras.Sequential([
        efficientnet.EfficientNetV1L2(input_shape=(args.dim, args.dim, args.n_channels), pretrained=args.weights, num_classes=0),
