...
parser.add_int('--batch_size',        default=64,            help='Batch size')
parser.add_bool('--drop_remainder',   default=False,         help='Whether to drop remainder')
parser.add_float('--lr',              default=5e-4,          help='Learning rate')
...
def init_model(print_summary=True):
    model = tf.keras.Sequential([
        efficientnet.EfficientNetV2L(input_shape=(args.dim, args.dim, args.n_channels), pretrained=args.weights, num_classes=0),
